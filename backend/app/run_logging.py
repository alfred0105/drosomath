...
class RunLogger:
        ...
        with self._metrics_path.open("a", newline="", encoding="utf-8") as handle:
            ...
            writer.writerow(
                [
                    ...
                    frame.get("evaluation_profile"),
                    frame.get("profile_trial"),
    ...
    def _write_summary(self, status: str, ended_at: datetime | None = None) -> None:
        ...
        summary = {
            ...
            "total_evaluation_trials": self.config.get("total_evaluation_trials"),
            "evaluation_learning_enabled": self.config.get("evaluation_learning_enabled"),
            "current_profile": metrics.get("current_profile") or last.get("evaluation_profile"),
            "current_profile_trial": metrics.get("profile_trial") or last.get("profile_trial"),
            "profile_results": metrics.get("profiles"),
            "experiment_complete": bool(metrics.get("experiment_complete", False)),
